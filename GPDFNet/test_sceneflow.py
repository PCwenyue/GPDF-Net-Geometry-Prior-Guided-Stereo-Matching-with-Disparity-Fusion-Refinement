...
parser = argparse.ArgumentParser(description='Geometry Prior Guided Stereo Matching with Disparity Fusion Refinement (GPDFNet)')
parser.add_argument('--model', default='GPDFnet', help='select a model structure', choices=__models__.keys())
